...
<footer>
  <div className="wrap">
    <div className="foot-wrap">
      <div className="foot-logo"><em>Arvind</em><span>.</span></div>
      <div className="foot-copy">© 2025 Arvind Lodhi · Bhopal / Hyderabad, India</div>
      <div className="foot-links">
        <a href="mailto:arvindlodhi850@gmail.com">
          <svg viewBox="0 0 24 24" fill="none" stroke="currentColor" strokeWidth="2" strokeLinecap="round" strokeLinejoin="round"><path d="M4 4h16c1.1 0 2 .9 2 2v12c0 1.1-.9 2-2 2H4c-1.1 0-2-.9-2-2V6c0-1.1.9-2 2-2z"/><polyline points="22,6 12,13 2,6"/></svg>
          Email
        </a>
        <a href="https://www.linkedin.com/in/arvindlodhi" target="_blank">
        ...
        <a href="https://github.com/Arvindlodhi2001" target="_blank">
